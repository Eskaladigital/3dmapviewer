...
export const FURNITURE_CATALOG: FurnitureCatalogItem[] = [
  ...
  { type: 'restaurant_table_round_2', category: 'restaurant', label: 'Mesa redonda 2p', icon: '🍽️', width: 0.7, depth: 0.7, height: 0.75, defaultColor: '#F5F5F5', defaultMaterial: 'marble' },
  { type: 'restaurant_table_round_4', category: 'restaurant', label: 'Mesa redonda 4p', icon: '🍽️', width: 1.0, depth: 1.0, height: 0.75, defaultColor: '#F5F5F5', defaultMaterial: 'marble' },
  { type: 'restaurant_table_rect_4', category: 'restaurant', label: 'Mesa rect. 4p', icon: '🍽️', width: 1.2, depth: 0.8, height: 0.75, defaultColor: '#C4A574', defaultMaterial: 'furnitureWood' },
  { type: 'restaurant_table_rect_6', category: 'restaurant', label: 'Mesa rect. 6p', icon: '🍽️', width: 1.8, depth: 0.9, height: 0.75, defaultColor: '#C4A574', defaultMaterial: 'furnitureWood' },
  { type: 'restaurant_table_rect_8', category: 'restaurant', label: 'Mesa rect. 8p', icon: '🍽️', width: 2.4, depth: 1.0, height: 0.75, defaultColor: '#C4A574', defaultMaterial: 'furnitureWood' },
  { type: 'restaurant_booth', category: 'restaurant', label: 'Banco corrido (booth)', icon: '🛋️', width: 1.5, depth: 0.6, height: 1.1, defaultColor: '#8B2500', defaultMaterial: 'fabric' },
  { type: 'restaurant_booth_corner', category: 'restaurant', label: 'Booth esquinero', icon: '🛋️', width: 1.8, depth: 1.8, height: 1.1, defaultColor: '#8B2500', defaultMaterial: 'fabric' },
  { type: 'restaurant_chair', category: 'restaurant', label: 'Silla restaurante', icon: '🪑', width: 0.45, depth: 0.48, height: 0.88, defaultColor: '#3A2E24', defaultMaterial: 'wood' },
  { type: 'restaurant_chair_upholstered', category: 'restaurant', label: 'Silla tapizada', icon: '🪑', width: 0.50, depth: 0.52, height: 0.90, defaultColor: '#5C4033', defaultMaterial: 'fabric' },
  { type: 'restaurant_bar_long', category: 'restaurant', label: 'Barra restaurante larga', icon: '🍸', width: 3.5, depth: 0.7, height: 1.15, defaultColor: '#3A2E24', defaultMaterial: 'wood' },
  { type: 'restaurant_bar_L', category: 'restaurant', label: 'Barra en L', icon: '🍸', width: 3.0, depth: 2.0, height: 1.15, defaultColor: '#3A2E24', defaultMaterial: 'wood' },
  { type: 'wine_rack', category: 'restaurant', label: 'Botellero / Vinoteca', icon: '🍷', width: 1.0, depth: 0.4, height: 1.8, defaultColor: '#3A2E24', defaultMaterial: 'wood' },
  { type: 'wine_cooler', category: 'restaurant', label: 'Nevera de vinos', icon: '🍷', width: 0.6, depth: 0.6, height: 1.5, defaultColor: '#1a1a1a', defaultMaterial: 'metal' },
  { type: 'buffet_table', category: 'restaurant', label: 'Mesa buffet', icon: '🍲', width: 2.0, depth: 0.8, height: 0.85, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'salad_bar', category: 'restaurant', label: 'Barra ensaladas', icon: '🥗', width: 1.8, depth: 0.7, height: 0.85, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'service_station', category: 'restaurant', label: 'Estación de servicio', icon: '🧊', width: 0.8, depth: 0.5, height: 0.90, defaultColor: '#4A3728', defaultMaterial: 'wood' },
  { type: 'host_stand', category: 'restaurant', label: 'Atril de maître', icon: '📋', width: 0.5, depth: 0.4, height: 1.1, defaultColor: '#3A2E24', defaultMaterial: 'wood' },
  { type: 'food_display_case', category: 'restaurant', label: 'Vitrina expositora', icon: '🍰', width: 1.2, depth: 0.7, height: 1.3, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'pizza_oven', category: 'restaurant', label: 'Horno de pizza', icon: '🍕', width: 1.4, depth: 1.4, height: 1.6, defaultColor: '#C85A17', defaultMaterial: 'ceramic' },
  { type: 'coffee_machine_pro', category: 'restaurant', label: 'Cafetera profesional', icon: '☕', width: 0.7, depth: 0.5, height: 0.55, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'ice_machine', category: 'restaurant', label: 'Máquina de hielo', icon: '🧊', width: 0.6, depth: 0.6, height: 0.85, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'soda_fountain', category: 'restaurant', label: 'Dispensador refrescos', icon: '🥤', width: 0.5, depth: 0.4, height: 0.6, defaultColor: '#2F2F2F', defaultMaterial: 'metal' },
  { type: 'cash_register_restaurant', category: 'restaurant', label: 'TPV / Caja restaurante', icon: '💰', width: 0.5, depth: 0.4, height: 0.45, defaultColor: '#2F2F2F', defaultMaterial: 'metal' },
  { type: 'restaurant_partition', category: 'restaurant', label: 'Separador / Biombo', icon: '🪟', width: 1.5, depth: 0.1, height: 1.5, defaultColor: '#3A2E24', defaultMaterial: 'wood' },
  { type: 'outdoor_table_parasol', category: 'restaurant', label: 'Mesa terraza + sombrilla', icon: '⛱️', width: 1.0, depth: 1.0, height: 2.2, defaultColor: '#F5F5DC', defaultMaterial: 'fabric' },
  { type: 'outdoor_chair', category: 'restaurant', label: 'Silla terraza', icon: '🪑', width: 0.48, depth: 0.50, height: 0.85, defaultColor: '#808080', defaultMaterial: 'metal' },
  { type: 'industrial_kitchen_table', category: 'restaurant', label: 'Mesa acero inox cocina', icon: '🍳', width: 2.0, depth: 0.7, height: 0.90, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'commercial_fridge', category: 'restaurant', label: 'Nevera industrial', icon: '🧊', width: 0.7, depth: 0.8, height: 2.0, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'commercial_freezer', category: 'restaurant', label: 'Congelador industrial', icon: '🧊', width: 0.7, depth: 0.8, height: 2.0, defaultColor: '#888888', defaultMaterial: 'metal' },
  { type: 'commercial_range', category: 'restaurant', label: 'Cocina industrial (fogones)', icon: '🔥', width: 1.2, depth: 0.8, height: 0.90, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'deep_fryer', category: 'restaurant', label: 'Freidora industrial', icon: '🍟', width: 0.5, depth: 0.6, height: 0.85, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'commercial_dishwasher', category: 'restaurant', label: 'Lavavajillas industrial', icon: '🫧', width: 0.7, depth: 0.7, height: 1.5, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'commercial_hood', category: 'restaurant', label: 'Campana industrial', icon: '💨', width: 2.0, depth: 1.0, height: 0.5, defaultColor: '#C0C0C0', defaultMaterial: 'metal' },
  { type: 'plancha_grill', category: 'restaurant', label: 'Plancha / Grill', icon: '🥩', width: 0.8, depth: 0.7, height: 0.90, defaultColor: '#2F2F2F', defaultMaterial: 'metal' },
